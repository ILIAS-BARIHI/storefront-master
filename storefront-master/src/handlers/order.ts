...
const order_routes = (app: express.Application): void => {
    ...
    app.get('/orders/:id', verifyAuthToken, async (req, res) => {
        try {
    ...
    app.post('/orders/:user_id', verifyAuthToken, async (req, res) => {
        try {
    ...
    app.post('/orders/:id/add', verifyAuthToken, async (req, res) => {
        try {
